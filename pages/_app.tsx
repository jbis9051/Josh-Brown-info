    ...
    return (
        <>
            <Head>
                ...
                <meta
                    property="og:image"
                    content="/assets/images/thiswebsite/code_small.png"
                />
                ...
                />
                <link
                    href="https://fonts.googleapis.com/css?family=Lato:400,500,700,800,900&display=swap"
                    rel="stylesheet"
                />
                <link
                    href="https://fonts.googleapis.com/css?family=Hind|Nunito:400,600,700,800,900&display=swap"
                    rel="stylesheet"
                />
                {/* Favicon */}
                <link
