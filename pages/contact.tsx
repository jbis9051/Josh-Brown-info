...
export default function Contact() {
    ...
    const [errors, setErrors] = useState<IFormError>({name: null, email: null, message: null, genericError: null});

    function onSubmit(e: FormEvent) {
        e.preventDefault();
        const errors: IFormError = {name: null, email: null, message: null, genericError: null};
        ...
        fetch('/api/contact', {
            ...
            if (!res.ok) {
                ...
                setErrors({email: null, message: null, name: null, genericError: "Unknown Error Occurred"})
                return;
            }
                ...
                {(() => {
                    switch (state) {
                        case State.SUBMITTED:
                            return (
                                <div>
                                    <span className={styles.successText}>Success! Thanks for contacting me.</span>
                                </div>
                            );
                        case State.LOADING:
                            return (
